...
\begin{questions}
   ...
   \begin{solution}
      In standard CCA, the squared sample canonical correlations $r^2$ are
      the eigenvalues of the matrix 
      \begin{align*}
         \mathbf{S}_{11}^{-\frac{1}{2}}
         \mathbf{S}_{12} \mathbf{S}_{22}^{-1}
         \mathbf{S}_{21}\mathbf{S}_{11}^{-\frac{1}{2}} = 
         \frac{1}{s_y^2} \mathbf{s}_{yX}^T
      ...
      Now, consider the multiple linear regression of $Y$ on the variables in
      ...
      \mathbf{s}_{Xy}$:
      \begin{align*}
         SS_{Reg} &= (\mathbf{S}_{XX}^{-1} \mathbf{s}_{Xy})^T \mathbf{s}_{Xy}
   ...
   \begin{solution}
      ...
      than a normal distribution. The data is "fat-tailed," meaning extreme
      outliers are more frequent than the normal model predicts. Therefore, a
      heavy tailed distribution (like Cauchy distribution ot $t$-distribution
      with low degrees of freedom) would provide better fit to the model.
   \end{solution}
